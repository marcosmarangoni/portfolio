      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarResponsive">
          <ul className="navbar-nav ml-auto">
            <li className="nav-item"><a className="nav-link js-scroll-trigger" href="/#masthead">About</a></li>
            <li className="nav-item"><a className="nav-link js-scroll-trigger" href="/#projects">Projects</a></li>
            <li className="nav-item"><a className="nav-link js-scroll-trigger" href="/#contacts">Contact</a></li>
            <li className="nav-item dropdown">
              ...
              <div className="dropdown-menu" aria-labelledby="personalProjectsDropdown">
                <a href="/dijkstra" className="dropdown-item">Dijkstra</a>
              </div>
            </li>
          </ul>
        </div>
